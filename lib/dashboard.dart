              ...
              child: Card(
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    Container(
                      margin: EdgeInsets.only(left: 10, right: 10),
                      child: Text("La función principal es actuar como un puente entre proveedores de software y potenciales "
      ...
      floatingActionButton: FloatingActionButton(
        ...
        onPressed: (){
          Navigator.push(context, MaterialPageRoute(builder: (BuildContext context){
            return setting(this.clienteData);
          }));
        },
      ),
    );
